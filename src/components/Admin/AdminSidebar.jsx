...
const AdminSidebar = () => {
  ...
  const menuItems = [
    {
      id: 'dashboard',
      icon: (
        // Ikon Dasbor: Grafik/papan informasi
    ...
    },
    {
      id: 'tickets',
      icon: (
        // Ikon Tiket: Mirip tiket antrean
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      icon: (
        // Ikon Departemen: Bangunan rumah sakit/gedung
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      path: '/admin/add-department', // Pastikan ini sesuai dengan routing App.js
      label: 'Manajemen Departemen'
    },
    {
      id: 'staff-management',
      icon: (
        // Ikon Staf: Orang dengan lencana/dokumen
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      path: '/admin/add-staff', // Pastikan ini sesuai dengan routing App.js
  ...
  const isActive = (path) => {
    // Memperbarui logika isActive untuk menangani rute manajemen yang baru
    // Misalnya, jika path adalah /admin/departments-management, ini akan cocok
  ...
  return (
    <div className="fixed left-0 top-0 h-full w-20 bg-gradient-to-b from-blue-600 to-blue-800 shadow-lg z-50 flex flex-col">
      ...
      <div className="p-3 border-t border-white/20">
        <div className="w-14 h-14 bg-white/20 rounded-xl flex items-center justify-center cursor-pointer hover:bg-white/30 transition-colors group">
