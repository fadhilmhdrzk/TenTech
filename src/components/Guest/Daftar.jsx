...
import MultiDepartmentQueueBoard from "../../components/MultiDepartmentQueueBoard"; // ✅ BOARD SEMUA POLI
...
export default function Daftar() {
  return (
    <div className="bg-[#00afc5] text-white text-center py-16 px-4">
      ...
      {/* ✅ Tampilkan Semua Poli (Anak, Umum, Penyakit Dalam) */}
      <div className="mb-8">
        <MultiDepartmentQueueBoard />
      </div>

      <Link
        to="/guest"
        className="inline-block bg-white text-cyan-500 font-semibold px-9 py-2 rounded-full hover:bg-gray-300 transition"
      >
        Daftar Sekarang
      </Link>
    </div>
