...
export default function Tickets() {
  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen">
      <h1 className="text-3xl font-extrabold text-[#00afc5] mb-6">Manajemen Antrean Tiket</h1>
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-6">
        ...
        <div className="flex items-end">
          <button
            ...
            className="px-4 py-2 rounded-md text-white font-semibold shadow transition bg-[#00afc5] hover:bg-[#00afc5] w-full md:w-auto"
            disabled={loading}
          >
            {loading ? "Memuat Ulang..." : "Muat Ulang Tiket"}
          </button>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="overflow-x-auto bg-white rounded-lg shadow-xl">
          <table className="table w-full">
            <thead className="bg-[#00afc5] text-white sticky top-0 z-10">
              <tr>
